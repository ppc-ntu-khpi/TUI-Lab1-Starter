# Лабораторні роботи - створення інтерфейсів користувача різних видів
...
На даний момент в репозиторії містяться:
...
Всі необхідні бібліотеки містяться у теці [jars](https://github.com/liketaurus/TUI-Labs/tree/master/jars). В тому числі - всі необхідні класи з робіт 1-8 - файл [MyBank.jar](https://github.com/liketaurus/TUI-Labs/blob/master/jars/MyBank.jar). Файд даних - у теці [data](https://github.com/liketaurus/TUI-Labs/tree/master/data).
